...
public class Bruh {
    ...
    // throw new BruhException("Idk what u tryna say, pls try again with one of the
    // commands:\r\n "
    ...
    // "Invalid date format\r\n Pls use in form \'list {date}\' or \'list\' and try
    // again\r\n "
    ...
    // if (commandArgument.trim().isEmpty()) {
    // throw new BruhException(
    // "u want mark what? air ah?\r\n Pls use in form \'mark {task-number}\' and try
    // again");
    // }
    // try {
    // Integer index = !commandArgument.isEmpty() ?
    // Integer.parseInt(commandArgument.trim()) - 1 : -1;
    ...
    // } catch (NumberFormatException e) {
    // throw new BruhException(
    // "Idk what u tryna unmark... pls use in form \\'mark {task-number}\\' and try
    // again");
    // }
    // break;
    // case DELETE:
    ...
    // } catch (NumberFormatException e) {
    // throw new BruhException(
    // "Idk what u tryna delete... pls use in form \\'delete {task-number}\\' and
    // try again");
    // }
    // break;
    // case TODO:
    // if (commandArgument.isEmpty()) {
    // throw new BruhException("ERROR!!! The description of a todo cannot be
    // empty.\r\n "
    ...
    // + "Please use in form \'event {task-name} /from {start-time} /to {end-time}\'
    // and try again\r\n "
    // + "Please use format of time: yyyy-MM-dd HH:mm (e.g. 2023-03-15 14:30)");
    // } else {
    // String[] timeParts = eventParts[1].split(" /to ", 2);
    // if (timeParts.length < 2) {
    // throw new BruhException("ERROR!!! The start and end time not specified
    // properly.\r\n "
    // + "Please use in form \'event {task-name} /from {start-time} /to {end-time}\'
    // and try again\r\n "
    // + "Please use format of time: yyyy-MM-dd HH:mm (e.g. 2023-03-15 14:30)");
